...
public class GenericViewPagerSuccesAdapter extends android.support.v4.view.PagerAdapter {
    ...
    public GenericViewPagerSuccesAdapter(Context context, List<AdapterStringModel> items) {
