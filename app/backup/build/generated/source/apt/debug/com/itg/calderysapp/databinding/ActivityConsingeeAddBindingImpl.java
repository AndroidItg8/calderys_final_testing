...
public class ActivityConsingeeAddBindingImpl extends ActivityConsingeeAddBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"content_consingee_add"},
            new int[] {1},
            new int[] {R.layout.content_consingee_add});
    ...
    public ActivityConsingeeAddBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ActivityConsingeeAddBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (com.itg.calderysapp.databinding.ContentConsingeeAddBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContent((com.itg.calderysapp.databinding.ContentConsingeeAddBinding) object, fieldId);
            case 1 :
    ...
    private boolean onChangeContent(com.itg.calderysapp.databinding.ContentConsingeeAddBinding Content, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            this.content.setConsigneeModel(consigneeModel);
        }
