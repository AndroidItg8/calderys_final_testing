...
public class ActivityProductListBindingImpl extends ActivityProductListBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"content_product_list"},
            new int[] {1},
            new int[] {R.layout.content_product_list});
    ...
    public ActivityProductListBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private ActivityProductListBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (com.itg.calderysapp.databinding.ContentProductListBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContent((com.itg.calderysapp.databinding.ContentProductListBinding) object, fieldId);
            case 1 :
    ...
    private boolean onChangeContent(com.itg.calderysapp.databinding.ContentProductListBinding Content, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            this.content.setProductListModel(productListModel);
        }
