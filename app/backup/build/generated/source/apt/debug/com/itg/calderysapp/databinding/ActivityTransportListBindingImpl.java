...
public class ActivityTransportListBindingImpl extends ActivityTransportListBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"content_transport_list"},
            new int[] {1},
            new int[] {R.layout.content_transport_list});
    ...
    public ActivityTransportListBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ActivityTransportListBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (com.itg.calderysapp.databinding.ContentTransportListBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeContent((com.itg.calderysapp.databinding.ContentTransportListBinding) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeContent(com.itg.calderysapp.databinding.ContentTransportListBinding Content, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            this.content.setTransportModel(transportModel);
        }
